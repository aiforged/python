...
def _get_kwargs(
    *,
    client: Client,
    json_body: AIForgedViewModelsNotificationViewModel,
    x_api_version: Union[Unset, None, str] = UNSET,
) -> Dict[str, Any]:
    url = "{}/api/Notification/Create".format(client.base_url)
...
def sync_detailed(
    *,
    ...
    Args:
        ...
        json_body (AIForgedViewModelsNotificationViewModel): System Notifications
