...
def _get_kwargs(
    *,
    ...
    url = "{}/api/Notification/Get".format(client.base_url)
...
def _parse_response(*, response: httpx.Response) -> Optional[List[AIForgedViewModelsNotificationViewModel]]:
    if response.status_code == 200:
        response_200 = []
        _response_200 = response.json()
        for response_200_item_data in _response_200:
            response_200_item = AIForgedViewModelsNotificationViewModel.from_dict(response_200_item_data)
...
def _build_response(*, response: httpx.Response) -> Response[List[AIForgedViewModelsNotificationViewModel]]:
    return Response(
...
def sync_detailed(
    *,
    ...
    sort_direction: Union[AIForgedDALSortDirection, None, Unset] = UNSET,
    x_api_version: Union[Unset, None, str] = UNSET,
) -> Response[List[AIForgedViewModelsNotificationViewModel]]:
    """Get Notifications
...
def sync(
    *,
    ...
    sort_direction: Union[AIForgedDALSortDirection, None, Unset] = UNSET,
    x_api_version: Union[Unset, None, str] = UNSET,
) -> Optional[List[AIForgedViewModelsNotificationViewModel]]:
    """Get Notifications
