...
def _get_kwargs(
    *,
    ...
    method: Union[Unset, None, AIForgedDALWorkItemMethod] = AIForgedDALWorkItemMethod.VALUE_0,
    graceperiod: Union[Unset, None, str] = UNSET,
    x_api_version: Union[Unset, None, str] = UNSET,
) -> Dict[str, Any]:
    url = "{}/api/WorkItem/Create".format(client.base_url)
    ...
    *,
    ...
    Args:
        ...
        method (Union[Unset, None, AIForgedDALWorkItemMethod]): Work items assignment method
            Default: AIForgedDALWorkItemMethod.VALUE_0.
