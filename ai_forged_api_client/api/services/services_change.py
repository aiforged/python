...
def _get_kwargs(
    *,
    ...
    newstdp_id: Union[Unset, None, int] = UNSET,
    x_api_version: Union[Unset, None, str] = UNSET,
) -> Dict[str, Any]:
    url = "{}/api/Services/Change".format(client.base_url)
...
def sync_detailed(
    *,
    ...
    Args:
        ...
        newstdp_id (Union[Unset, None, int]):
