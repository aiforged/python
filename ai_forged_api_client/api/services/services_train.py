...
def _get_kwargs(
    *,
    ...
    force_retraining: Union[Unset, None, bool] = False,
    x_api_version: Union[Unset, None, str] = UNSET,
) -> Dict[str, Any]:
    url = "{}/api/Services/Train".format(client.base_url)
    ...
    params: Dict[str, Any] = {
        ...
        "stpdId": stpd_id,
        "forceRetraining": force_retraining,
    }
...
def sync_detailed(
    *,
    ...
    Args:
        ...
        force_retraining (Union[Unset, None, bool]):
