...
def _get_kwargs(
    *,
    ...
    get_labelled_stats: Union[Unset, None, bool] = False,
    x_api_version: Union[Unset, None, str] = UNSET,
) -> Dict[str, Any]:
    url = "{}/api/Document/GetExtendedSummary".format(client.base_url)
    ...
    params: Dict[str, Any] = {
        ...
        "masterid": masterid,
        "interval": interval,
        "getLabelledStats": get_labelled_stats,
    }
...
def sync_detailed(
    *,
    ...
    Args:
        ...
        get_labelled_stats (Union[Unset, None, bool]):
    ...
    kwargs = _get_kwargs(
        ...
        masterid=masterid,
        interval=interval,
        get_labelled_stats=get_labelled_stats,
