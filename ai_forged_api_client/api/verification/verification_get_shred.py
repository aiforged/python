...
def _get_kwargs(
    *,
    ...
    par_id: Union[Unset, None, int] = UNSET,
    verification_id: Union[Unset, None, int] = UNSET,
    inline: Union[Unset, None, bool] = False,
    x_api_version: Union[Unset, None, str] = UNSET,
) -> Dict[str, Any]:
    url = "{}/api/Verification/GetShred".format(client.base_url)
...
def sync_detailed(
    *,
    ...
    Args:
        ...
        par_id (Union[Unset, None, int]):
        verification_id (Union[Unset, None, int]):
        inline (Union[Unset, None, bool]):
