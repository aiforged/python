...
T = TypeVar("T", bound="UserSettingsSetPictureMultipartData")


@attr.s(auto_attribs=True)
class UserSettingsSetPictureMultipartData:
    """
    Attributes:
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        user_settings_set_picture_multipart_data = cls(
            file=file,
        )

        user_settings_set_picture_multipart_data.additional_properties = d
        return user_settings_set_picture_multipart_data
