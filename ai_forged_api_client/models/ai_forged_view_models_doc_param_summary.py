...
T = TypeVar("T", bound="AIForgedViewModelsDocParamSummary")


@attr.s(auto_attribs=True)
class AIForgedViewModelsDocParamSummary:
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        ai_forged_view_models_doc_param_summary = cls(
        ...
        return ai_forged_view_models_doc_param_summary
