...
T = TypeVar("T", bound="DocumentExtractAndVerifyMultipartData")


@attr.s(auto_attribs=True)
class DocumentExtractAndVerifyMultipartData:
    """
    Attributes:
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        document_extract_and_verify_multipart_data = cls(
            file=file,
        )

        document_extract_and_verify_multipart_data.additional_properties = d
        return document_extract_and_verify_multipart_data
